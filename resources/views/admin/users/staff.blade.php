                        ...
                        <div class="card border-0 shadow-sm">
                            <div class="card-header bg-white border-0 py-3 d-flex justify-content-between align-items-center">
                                <div>
                                    ...
                                    <p class="mb-0 text-muted">Manage administrative staff (Super Admins, Admins, Editors)</p>
                                </div>
                                <a href="{{ route('admin.users.create', ['role' => 'staff']) }}" class="btn btn-theme rounded-pill px-4">
