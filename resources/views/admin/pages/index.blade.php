                    ...
                    <div class="col-12">
                        <div class="card border-0 shadow-sm">
                            <div class="card-header bg-white border-0 py-3 d-flex justify-content-between align-items-center">
                                <div>
                                    <h4 class="card-title mb-0 fw-bold">Pages</h4>
                                    <p class="mb-0 text-muted">Manage all pages</p>
                                </div>
                                <a href="{{ route('admin.pages.create') }}" class="btn btn-theme rounded-pill px-4">
